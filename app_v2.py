#!/usr/bin/env python3
"""
Reproducible Hypothesis Generator - Web Interface v2
Based on the working generate_reproducible_hypotheses.py script
"""
...
# Page config
st.set_page_config(
    page_title="Reproducible Hypothesis Generator",
    page_icon="🔬",
    layout="wide",
...
def run_pipeline(df, config):
    ...
    st.text("💡 Stage 5/5: Generating hypotheses...")
    hypotheses = generate_data_driven_hypotheses(
        valid_df, 
        labels, 
        reproducible,
...
def main():
    st.title("🔬 Reproducible Hypothesis Generator")
